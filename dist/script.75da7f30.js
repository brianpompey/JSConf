...
var allConferences = [];
var tableHeadings = ["Name", "Date", "Time", "Minimum Donation", "Keynote", "Category", "Workshop Example", "Talk Example"]; // const loadTable = () => {
//   let table = document.createElement("table");
//   let headingTr = document.createElement("tr");
//   confTable.appendChild(table);
// };

var loadConferences = function loadConferences() {
  fetch("http://localhost:3000/api/v1/conferences/index").then(function (res) {
...
loadConferences(); // console.log(fetch("http://localhost:3000/api/v1/conferences/index"));
